			...
			<div className="space-y-2 sm:col-span-2">
				...
				<div>
					<p className="mb-10">
						...
						Suspendisse fermentum lectus mi, vitae vestibulum lacus aliquet ac.
						Aliquam odio ex, maximus eget gravida ut, interdum ut tortor.
					</p>
				</div>
				...
				<div className="mt-2 font-medium">
					<p className="mt-10">
						...
						).getMonth()}/${new Date(eventData?.createdAt || 0).getFullYear()}`}
					</p>
					<p className="">
						Event Last Updated On:-{" "}
						{`${new Date(eventData?.updatedAt || 0).getDate()}/${new Date(
							eventData?.updatedAt || 0
						).getMonth()}/${new Date(eventData?.updatedAt || 0).getFullYear()}`}
					</p>
				</div>
			</div>
			<div>
